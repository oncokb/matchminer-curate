package org.mskcc.oncokb;

import org.mskcc.oncokb.config.ApplicationProperties;
import org.mskcc.oncokb.config.DefaultProfileUtil;
...
public class MatchMinerCurateApp {

    private static final Logger log = LoggerFactory.getLogger(MatchMinerCurateApp.class);

    private final Environment env;

    public MatchMinerCurateApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes MatchMiner Curate.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MatchMinerCurateApp.class);
